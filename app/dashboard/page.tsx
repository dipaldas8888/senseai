...
export default async function DashboardPage() {
  ...
  const recentPipelines = [
    ...
    },
    {
      ...
      model: "SenseLLM-Medium",
      status: "Active",
      latency: "89ms",
      health: 98,
    },
    {
      name: "Financial Risk Evaluator",
      model: "SenseLLM-X",
      status: "Warning",
      latency: "312ms",
      health: 85,
              ...
              >
                ...
                <div className="mt-4">
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    <span
                      className={`text-xs font-semibold ${stat.isPositive ? "text-emerald-500" : "text-rose-500"}`}
                    >
                      {stat.change}
                    </span>
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-zinc-400">
                    Deployed models serving real-time requests.
                  </p>
                </div>
                <Link
                  href="#"
                    ...
                    {recentPipelines.map((pipeline, i) => (
                      <tr key={i} className="group hover:bg-zinc-900/10">
                        ...
                        <td className="py-4">
                          ...
                          >
                            <span
                              className={`h-1.5 w-1.5 rounded-full ${pipeline.status === "Active" ? "bg-emerald-400" : "bg-rose-400"}`}
                            />
                            {pipeline.status}
                          </span>
                        </td>
          ...
          <div className="flex flex-col gap-6">
            <div className="rounded-xl border border-zinc-900 bg-zinc-900/20 p-6 backdrop-blur-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 rounded-lg bg-zinc-900/50 border border-zinc-800">
                  ...
                  <span className="text-xs bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 py-0.5 px-2 rounded-full">
                    Active
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-zinc-900/50 border border-zinc-800">
                  ...
                  <span className="text-xs bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 py-0.5 px-2 rounded-full">
                    Shared
                  </span>
                </div>
              </div>
            ...
            <div className="rounded-xl border border-zinc-900 bg-gradient-to-br from-indigo-950/30 to-violet-950/20 p-6 backdrop-blur-sm">
              ...
              <p className="text-sm text-zinc-400 mb-4">
                Unlock high-throughput dedicated execution servers, advanced LLM
                fine-tuning, and priority token routing.
              </p>
